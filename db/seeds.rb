...
c2 = Contract.create(player:p2,team:t1,start_date:2019,expiration_date:2021,amount:2478471,salary:1824003,bonus:0)
c3 = Contract.create(player:p3,team:t1,start_date:2017,expiration_date:2022,amount:201158790,salary:40231758,bonus:0)
c4 = Contract.create(player:p4,team:t1,start_date:2020,expiration_date:2025,amount:118000000,salary:17469565,bonus:0)
c5 = Contract.create(player:p5,team:t1,start_date:2019,expiration_date:2022,amount:4515983,salary:842237,bonus:0)
c6 = Contract.create(player:p6,team:t1,start_date:2019,expiration_date:2022,amount:14464287,salary:4464286,bonus:0)
c7 = Contract.create(player:p7,team:t1,start_date:2019,expiration_date:2022,amount:3488384,salary:187782,bonus:0)
c8 = Contract.create(player:p8,team:t1,start_date:2019,expiration_date:2023,amount:4198912,salary:1399637,bonus:0)
c9 = Contract.create(player:p9,team:t1,start_date:2019,expiration_date:2021,amount:4028040,salary:1964760,bonus:0)
c10 = Contract.create(player:p10,team:t1,start_date:2019,expiration_date:2023,amount:6130000,salary:898310,bonus:0)
c11 = Contract.create(player:p11,team:t1,start_date:2018,expiration_date:2023,amount:147710050,salary:25467250,bonus:0)
c12 = Contract.create(player:p12,team:t1,start_date:2017,expiration_date:2020,amount:3650791,salary:350189,bonus:0)
...
c13 = Contract.create(player:p13,team:t2,start_date:2021,expiration_date:2023,amount:16071720,salary:7839960,bonus:0)
c14 = Contract.create(player:p14,team:t2,start_date:2019,expiration_date:2020,amount:1750000,salary:1750000,bonus:0)
c15 = Contract.create(player:p15,team:t2,start_date:2019,expiration_date:2022,amount:62100000,salary:20700000,bonus:0)
c16 = Contract.create(player:p16,team:t2,start_date:2020,expiration_date:2021,amount:15000000,salary:15000000,bonus:0)
c17 = Contract.create(player:p17,team:t2,start_date:2019,expiration_date:2021,amount:16000000,salary:8000000,bonus:0)
c18 = Contract.create(player:p18,team:t2,start_date:2019,expiration_date:2022,amount:4709013,salary:1569671,bonus:0)
c19 = Contract.create(player:p19,team:t2,start_date:2019,expiration_date:2021,amount:8200000,salary:4100000,bonus:0)
c20 = Contract.create(player:p20,team:t2,start_date:2016,expiration_date:2020,amount:42000000,salary:10500000,bonus:0)
c21 = Contract.create(player:p21,team:t2,start_date:2017,expiration_date:2020,amount:4096762,salary:1365587,bonus:0)
c22 = Contract.create(player:p22,team:t2,start_date:2019,expiration_date:2020,amount:3551100,salary:3551100,bonus:0)
c23 = Contract.create(player:p23,team:t2,start_date:2019,expiration_date:2022,amount:12708720,salary:4236240,bonus:0)
c24 = Contract.create(player:p24,team:t2,start_date:2017,expiration_date:2021,amount:18689218,salary:4672305,bonus:0)
c25 = Contract.create(player:p25,team:t2,start_date:2019,expiration_date:2021,amount:20000000,salary:10000000,bonus:0)
c26 = Contract.create(player:p26,team:t2,start_date:2017,expiration_date:2021,amount:17188557,salary:4297139,bonus:0)
c27 = Contract.create(player:p27,team:t2,start_date:2019,expiration_date:2021,amount:16000000,salary:8000000,bonus:0)
c28 = Contract.create(player:p28,team:t2,start_date:2018,expiration_date:2019,amount:1349383,salary:1349383,bonus:0)
c29 = Contract.create(player:p29,team:t2,start_date:2020,expiration_date:2022,amount:2416291,salary:1208146,bonus:0)
